...
const validUsername = 'anonyfan';
const validPassword = '1270698788erfan';
...
app.get('/getServerVersion', (req, res) => {
  const serverVersion = "1.0.1"; // Replace this with your actual server version
